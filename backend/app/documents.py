...
_NDA_FIELDS: List[FieldDef] = [
    ...
    FieldDef("governingLaw", "Governing Law", "Jurisdiction whose laws govern the agreement e.g. 'Delaware', 'England and Wales', 'California'", True, "text", "Delaware"),
    FieldDef("jurisdiction", "Jurisdiction", "Court location e.g. 'Wilmington, Delaware', 'England and Wales', 'any County Court in the UK'", True, "text", "Wilmington, Delaware"),
]
...
REGISTRY["cloud_service_agreement"] = _make_config(
    ...
    fields=[
        ...
        FieldDef("governingLaw", "Governing Law", "Jurisdiction whose laws govern the agreement e.g. 'Delaware', 'England and Wales', 'California'", True, "text", "Delaware"),
        FieldDef("chosenCourts", "Chosen Courts", "Courts with exclusive jurisdiction e.g. 'courts in Wilmington, Delaware', 'courts of England and Wales', 'any County Court in the UK'", True, "text", "courts located in Wilmington, Delaware"),
    ],
